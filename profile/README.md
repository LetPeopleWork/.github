...
| --------- | --------- |
| [FlowPulse](https://github.com/LetPeopleWork/FlowPulse) | A Python package to generate Flow Metric Charts and run Forecasts using MCS from various data sources. Either use a CSV file, or based on data that will be fetched from Jira via JQL or Azure DevOps via WIQL |
